...
Load the design matrix. This indicates which samples correspond to which cell populations. We will learn more about design matrices in [later chapters](summarizedexperiment.html#summarizedexperiment).
