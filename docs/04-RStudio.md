...
1. Change the `colour_by` setting to "group" so you can easily distinguish between groups. In this data, the "group" is cell type.
    ...
    <img src="04-RStudio_files/figure-html//1BLTCaogA04bbeSD1tR1Wt-mVceQA6FHXa8FmFzIARrg_g11f12bc99af_0_77.png" title="Screenshot of the Glimma popout showing the data in an MDS plot. Data points are colored blue, orange, and green by group. The colour by dropdown menu on the interactive plot is hightlighted." alt="Screenshot of the Glimma popout showing the data in an MDS plot. Data points are colored blue, orange, and green by group. The colour by dropdown menu on the interactive plot is hightlighted." width="480" />
