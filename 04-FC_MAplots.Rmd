...
# Needed for GHA
BiocManager::install("matrixStats", update = TRUE)
BiocManager::install(c("MatrixGenerics", "DelayedArray", "SummarizedExperiment"), update = FALSE)
BiocManager::install(c("Glimma", "limma"), update = FALSE)
```
